...
# 3. song
song = "Abc" #string variable
# 4. food
food = "hotdogs" #string variable
# 5. number
...
# print( "I can count to " + str(number1) + ", " + str(number2) + ", " + str(number3) + ", " + str(number4) + ", " + str(number5) + ". ")
...
print(3/2)
# #modulo
print(7%4) #remainder of two
# #powers
print(2**3)
# #get the max and min of a number
print(max(1,2)) #max number get the largest number
print(min(1,2)) #max number get the smallest number
# #round a number
print(round(3.4))
# # absolute value
print(abs(-3)) #absolute value of a number
#absoulte value is the distance from 0 to the
# # order of operations
print(2 + 10 * 10 + 3)
